...
public class SalvarCarregar {
	...
	public static final String nameFileWorld = "world.world", nameFileWorldconfig = "world.config",
			startWorldName = "world", nameFolderImagens = "imagens", nameFileImageData = "data.config",
	...
	public static void salvarConfiguracoesMundo() throws IOException {
		...
		SimpleMultiplayerLoader.aConfig.atualizarAntesSalvar();

		writer.write(toJSON(SimpleMultiplayerLoader.aConfig));
		writer.flush();
		writer.close();
	...
	public static Tile[] carregarMundo(File prfile) throws Exception {
		SimpleMultiplayerLoader.aConfig = carregarConfiguracoesMundo(new File(prfile + "/" + nameFileWorldconfig));
