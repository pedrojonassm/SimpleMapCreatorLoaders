...
public class SimpleMultiplayerLoader extends Canvas
	...
	public static SimpleMultiplayerLoader instance;

	public static boolean podeNovaMovimentacao;

	public SimpleMultiplayerLoader() {
		instance = this;
	...
	public void startGerador() {
		...
		World.log_ts = Uteis.log(SimpleMultiplayerLoader.TileSize, 2);
		ui = new Ui();
	...
	public static void main(String args[]) {
		SimpleMultiplayerLoader gerador = new SimpleMultiplayerLoader();
		if (World.ok)
			gerador.start();
	}
